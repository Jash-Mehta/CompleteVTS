...
DateWiseSearchAlertNotificationResponse dateWiseSearchAlertNotificationResponseFromJson(String str) => DateWiseSearchAlertNotificationResponse.fromJson(json.decode(str));

String dateWiseSearchAlertNotificationResponseToJson(DateWiseSearchAlertNotificationResponse data) => json.encode(data.toJson());

class DateWiseSearchAlertNotificationResponse {
  ...
  List<DateWiseSearchAlertDatum>? data;
  bool ?succeeded;
  dynamic errors;
  dynamic message;

  factory DateWiseSearchAlertNotificationResponse.fromJson(Map<String, dynamic> json) => DateWiseSearchAlertNotificationResponse(
    ...
    data:json["data"]==null ?  null : List<DateWiseSearchAlertDatum>.from(json["data"].map((x) => DateWiseSearchAlertDatum.fromJson(x))),
...
class DateWiseSearchAlertDatum {
  DateWiseSearchAlertDatum({
    this.srNo,
    this.vendorSrNo,
    this.vendorName,
    this.branchSrNo,
  ...
  factory DateWiseSearchAlertDatum.fromJson(Map<String, dynamic> json) => DateWiseSearchAlertDatum(
