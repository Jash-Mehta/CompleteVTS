class DriverMasterReport {
  ...
  DriverMasterReport.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DriverMasterData>[];
      json['data'].forEach((v) {
        data!.add(new DriverMasterData.fromJson(v));
      });
    }
...
class DriverMasterData {
  ...
  DriverMasterData.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
