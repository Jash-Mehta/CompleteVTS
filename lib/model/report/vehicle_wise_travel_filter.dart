class VehicleWiseFilterModel {
  ...
  String? nextPage;
  String? previousPage;
  List<VehihcleWiseFilterData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  VehicleWiseFilterModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseFilterModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehihcleWiseFilterData>[];
      json['data'].forEach((v) {
        var filterdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        filterdata.forEach((element) {
          data!.add(new VehihcleWiseFilterData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehihcleWiseFilterData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehihcleWiseFilterData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!.add(new VehihcleWiseFilterData.fromJson(v));
      });
    }
  }
...
class VehihcleWiseFilterData {
  ...
  VehihcleWiseFilterData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
