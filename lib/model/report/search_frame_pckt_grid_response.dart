class SearchFramepacketgrid {
  ...
  String? nextPage;
  String? previousPage;
  List<DatewiseFramePacketGridViewItem>? data;
  bool? succeeded;
  String? errors;
  String? message;
  ...
  SearchFramepacketgrid.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DatewiseFramePacketGridViewItem>[];
      json['data'].forEach((v) {
        var searchItem = v['datewiseFramePacketGridViewData'] as List<dynamic>;
        searchItem.forEach((element) {
          data!.add(new DatewiseFramePacketGridViewItem.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DatewiseFramePacketGridViewItem>? datewiseFramePacketGridViewData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseFramePacketGridViewData'] != null) {
      datewiseFramePacketGridViewData = <DatewiseFramePacketGridViewItem>[];
      json['datewiseFramePacketGridViewData'].forEach((v) {
        datewiseFramePacketGridViewData!
            .add(new DatewiseFramePacketGridViewItem.fromJson(v));
      });
    }
  }
...
class DatewiseFramePacketGridViewItem {
  int? transID;
  String? header;
  String? vendorID;
  ...
  DatewiseFramePacketGridViewItem(
      {this.transID,
        this.header,
        this.vendorID,
  ...
  DatewiseFramePacketGridViewItem.fromJson(Map<String, dynamic> json) {
