class FrameGridFilterMode {
  ...
  FrameGridFilterMode.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  List<FrameGridFilterData>? datewiseFramePacketGridViewData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseFramePacketGridViewData'] != null) {
      datewiseFramePacketGridViewData = <FrameGridFilterData>[];
      json['datewiseFramePacketGridViewData'].forEach((v) {
        datewiseFramePacketGridViewData!
            .add(new FrameGridFilterData.fromJson(v));
      });
    }
  }
...
class FrameGridFilterData {
  ...
  FrameGridFilterData.fromJson(Map<String, dynamic> json) {
