class VehicleGroupFilterSearchModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<VehGroupFilterSearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  VehicleGroupFilterSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleGroupFilterSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehGroupFilterSearchData>[];
      json['data'].forEach((v) {
        var searchdata = v['datewiseTravelHoursData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new VehGroupFilterSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  String? totalHours;
  List<VehGroupFilterSearchData>? datewiseTravelHoursData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHoursData'] != null) {
      datewiseTravelHoursData = <VehGroupFilterSearchData>[];
      json['datewiseTravelHoursData'].forEach((v) {
        datewiseTravelHoursData!.add(new VehGroupFilterSearchData.fromJson(v));
      });
    }
  }
...
class VehGroupFilterSearchData {
  int? srNo;
  String? vehicleregNo;
  String? imei;
  String? tDate;
  ...
  VehGroupFilterSearchData.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
    vehicleregNo = json['vehicleregNo'];
    imei = json['imei'];
    tDate = json['tDate'];
