class VehicleWiseTWiseFilterSearchModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  Null? previousPage;
  List<VehicleWiseTWiseFilterSearchData>? data;
  bool? succeeded;
  Null? errors;
  Null? message;

  VehicleWiseTWiseFilterSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseTWiseFilterSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehicleWiseTWiseFilterSearchData>[];
      json['data'].forEach((v) {
        // data!.add(new VehicleWiseTWiseFilterSearchData.fromJson(v));
         var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new VehicleWiseTWiseFilterSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehicleWiseTWiseFilterSearchData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehicleWiseTWiseFilterSearchData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new VehicleWiseTWiseFilterSearchData.fromJson(v));
      });
    }
  }
...
class VehicleWiseTWiseFilterSearchData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  VehicleWiseTWiseFilterSearchData(
      {this.vehicleRegNo,
      this.imeino,
      this.latitude,
      this.longitude,
  ...
  VehicleWiseTWiseFilterSearchData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
