class SearchVehicleStatusGroupRpt {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  Null? previousPage;
  List<DatewiseTravelHoursDatum>? data;
  bool? succeeded;
  Null? errors;
  Null? message;

  SearchVehicleStatusGroupRpt(
      {this.pageNumber,
        this.pageSize,
        this.firstPage,
        this.lastPage,
  ...
  SearchVehicleStatusGroupRpt.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DatewiseTravelHoursDatum>[];
      json['data'].forEach((v) {
        var searchItem = v['datewiseTravelHoursData'] as List<dynamic>;
        searchItem.forEach((element) {
          data!.add(new DatewiseTravelHoursDatum.fromJson(element));
        });
    });
          };
...
class Data {
  ...
  String? totalHours;
  List<DatewiseTravelHoursDatum>? datewiseTravelHoursData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHoursData'] != null) {
      datewiseTravelHoursData = <DatewiseTravelHoursDatum>[];
      json['datewiseTravelHoursData'].forEach((v) {
        datewiseTravelHoursData!.add(new DatewiseTravelHoursDatum.fromJson(v));
      });
    }
  }
...
class DatewiseTravelHoursDatum {
  int? srNo;
  String? vehicleregNo;
  String? imei;
  String? tDate;
  ...
  DatewiseTravelHoursDatum.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
    vehicleregNo = json['vehicleregNo'];
    imei = json['imei'];
    tDate = json['tDate'];
