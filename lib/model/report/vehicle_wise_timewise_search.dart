class VehicleWiseTimeWiseSearchModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<VehicleWiseTimeWiseSearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  VehicleWiseTimeWiseSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseTimeWiseSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehicleWiseTimeWiseSearchData>[];
      json['data'].forEach((v) {
        var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new VehicleWiseTimeWiseSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehicleWiseTimeWiseSearchData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehicleWiseTimeWiseSearchData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new VehicleWiseTimeWiseSearchData.fromJson(v));
      });
    }
  }
...
class VehicleWiseTimeWiseSearchData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  VehicleWiseTimeWiseSearchData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo']??"";
    imeino = json['imeino']??"";
