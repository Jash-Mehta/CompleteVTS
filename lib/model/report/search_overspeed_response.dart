...
//   String? nextPage;
//   String? previousPage;
//   List<GroupByVehicleRegNoTotal>? data;
//   bool? succeeded;
//   String? errors;
//   String? message;
//
...
//     if (json['data'] != null) {
//       data = <OverSpeeddDetailData>[];
//       json['data'].forEach((v) {
//         data!.add(new OverSpeeddDetailData.fromJson(v));
//       });
//     }
...
//     if (this.data != null) {
//       data['groupByDateTotal'] = this.data!.map((v) => v.toJson()).toList();
//     }
...
//   List<OverSpeeddDetailData>? overSpeeddDetail;
//
//   Data(
//       {this.fromDate,
//         this.toDate,
...
//       overSpeeddDetail = <OverSpeeddDetailData>[];
//       json['overSpeeddDetail'].forEach((v) {
//         overSpeeddDetail!.add(new OverSpeeddDetailData.fromJson(v));
//       });
//     }
//   }
//
...
//         this.speedLimit});
//
//   OverSpeeddDetailData.fromJson(Map<String, dynamic> json) {
//     vehicleRegNo = json['vehicleRegNo']??"";
//     imeino = json['imeino']??"";
...
class SearchVehOverSpeedRpt {
  ...
  String? nextPage;
  String? previousPage;
  List<SearchOverSpeeddDetailItem>? data;
  bool? succeeded;
  String? errors;
  String? message;
  ...
  SearchVehOverSpeedRpt.fromJson(Map<String, dynamic> json) {
    ...
    previousPage = json['previousPage']??"";
    if (json['data'] != null) {
      data = <SearchOverSpeeddDetailItem>[];
      json['data'].forEach((v) {
        var searchItem = v['overSpeeddDetail'] as List<dynamic>;
        searchItem.forEach((element) {
          data!.add(new SearchOverSpeeddDetailItem.fromJson(element));
        });
      });
    }
    succeeded = json['succeeded']??false;
...
class searchOverspeedData {
  ...
  List<GroupByVehicleRegNoTotal>? groupByVehicleRegNoTotal;
  double? totalOverSpeedTravel;
  List<SearchOverSpeeddDetailItem>? overSpeeddDetail;
  ...
  searchOverspeedData.fromJson(Map<String, dynamic> json) {
    ...
    totalOverSpeedTravel = json['totalOverSpeedTravel'];
    if (json['overSpeeddDetail'] != null) {
      overSpeeddDetail = <SearchOverSpeeddDetailItem>[];
      json['overSpeeddDetail'].forEach((v) {
        overSpeeddDetail!.add(new SearchOverSpeeddDetailItem.fromJson(v));
      });
    }
  }
...
class SearchOverSpeeddDetailItem {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  SearchOverSpeeddDetailItem.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo']??"";
    imeino = json['imeino']??"";
    latitude = json['latitude']??"";
    longitude = json['longitude']??"";
