class VehicleSummaryFilterModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  Null? previousPage;
  List<VehicleSummaryFilterData>? data;
  bool? succeeded;
  Null? errors;
  Null? message;

  VehicleSummaryFilterModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleSummaryFilterModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehicleSummaryFilterData>[];
      json['data'].forEach((v) {
        var filterdata =
            v['datewiseStatusWiseTravelSummaryData'] as List<dynamic>;
        filterdata.forEach((element) {
          data!.add(new VehicleSummaryFilterData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehicleSummaryFilterData>? datewiseStatusWiseTravelSummaryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseStatusWiseTravelSummaryData'] != null) {
      datewiseStatusWiseTravelSummaryData = <VehicleSummaryFilterData>[];
      json['datewiseStatusWiseTravelSummaryData'].forEach((v) {
        datewiseStatusWiseTravelSummaryData!
            .add(new VehicleSummaryFilterData.fromJson(v));
      });
    }
  }
...
class VehicleSummaryFilterData {
  int? srNo;
  String? tDate;
  String? imei;
  String? vehicleregNo;
  ...
  VehicleSummaryFilterData.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
    tDate = json['tDate'];
    imei = json['imei'];
