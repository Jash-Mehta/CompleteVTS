class VehicleWiseTravelModel {
  ...
  VehicleWiseTravelModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  List<VehicleWiseData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehicleWiseData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!.add(new VehicleWiseData.fromJson(v));
      });
    }
  }
...
class VehicleWiseData {
  ...
  VehicleWiseData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
