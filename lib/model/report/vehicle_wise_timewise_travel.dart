class VehicleWiseTimeWiseTravelModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  VehicleWiseTimeWiseTravelModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseTimeWiseTravelModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehicleWiseTimeWiseData>[];
      json['data'].forEach((v) {
        var vehicledata = v['datewiseTravelHistoryData'] as List<dynamic>;
        vehicledata.forEach((element) {
          data!.add(new VehicleWiseTimeWiseData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehicleWiseTimeWiseData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehicleWiseTimeWiseData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!.add(new VehicleWiseTimeWiseData.fromJson(v));
      });
    }
  }
...
class VehicleWiseTimeWiseData {
  ...
  VehicleWiseTimeWiseData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
