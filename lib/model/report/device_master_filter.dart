class DeviceMasterFilterModel {
  ...
  String? nextPage;
  String? previousPage;
  List<DeviceMasterData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DeviceMasterFilterModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DeviceMasterFilterModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DeviceMasterData>[];
      json['data'].forEach((v) {
        data!.add(new DeviceMasterData.fromJson(v));
      });
    }
...
class DeviceMasterData {
  ...
  DeviceMasterData.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
