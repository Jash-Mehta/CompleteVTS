class DateTimeWiseDFilterSearchModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<DateTimewiseDFSData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DateTimeWiseDFilterSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DateTimeWiseDFilterSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DateTimewiseDFSData>[];
      json['data'].forEach((v) {
        var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new DateTimewiseDFSData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DateTimewiseDFSData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DateTimewiseDFSData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DateTimewiseDFSData.fromJson(v));
      });
    }
  }
...
class DateTimewiseDFSData {
  ...
  DateTimewiseDFSData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
