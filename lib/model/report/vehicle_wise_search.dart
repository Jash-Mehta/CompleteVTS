class VehicleWiseSearchModel {
  ...
  String? nextPage;
  String? previousPage;
  List<VehicleWiseSearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  VehicleWiseSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehicleWiseSearchData>[];
      json['data'].forEach((v) {
        var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new VehicleWiseSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehicleWiseSearchData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehicleWiseSearchData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!.add(new VehicleWiseSearchData.fromJson(v));
      });
    }
  }
...
class VehicleWiseSearchData {
  ...
  VehicleWiseSearchData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
