class DateAndTimeWiseFilter {
  ...
  String? nextPage;
  String? previousPage;
  List<DateAndTimewiseFilterData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DateAndTimeWiseFilter(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DateAndTimeWiseFilter.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DateAndTimewiseFilterData>[];
      json['data'].forEach((v) {
        var filterdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        filterdata.forEach((element) {
          data!.add(new DateAndTimewiseFilterData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DateAndTimewiseFilterData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DateAndTimewiseFilterData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DateAndTimewiseFilterData.fromJson(v));
      });
    }
  }
...
class DateAndTimewiseFilterData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  DateAndTimewiseFilterData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
