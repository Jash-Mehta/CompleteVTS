class OverSpeedFilter {
  ...
  OverSpeedFilter.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <OverSpeedFilterDetail>[];
      json['data'].forEach((v) {
        var overfilterdata = v['overSpeeddDetail'] as List<dynamic>;
        overfilterdata.forEach((element) {
          data!.add(new OverSpeedFilterDetail.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<OverSpeedFilterDetail>? overSpeeddDetail;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['overSpeeddDetail'] != null) {
      overSpeeddDetail = <OverSpeedFilterDetail>[];
      json['overSpeeddDetail'].forEach((v) {
        overSpeeddDetail!.add(new OverSpeedFilterDetail.fromJson(v));
      });
    }
  }
...
class OverSpeedFilterDetail {
  ...
  OverSpeedFilterDetail.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
