class DateAndTimeWiseTravel {
  ...
  DateAndTimeWiseTravel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DateAndTimewiseData>[];
      json['data'].forEach((v) {
        var dataandtimedata = v['datewiseTravelHistoryData'] as List<dynamic>;
        dataandtimedata.forEach((element) {
          data!.add(new DateAndTimewiseData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DateAndTimewiseData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DateAndTimewiseData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!.add(new DateAndTimewiseData.fromJson(v));
      });
    }
  }
...
class DateAndTimewiseData {
  ...
  DateAndTimewiseData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
