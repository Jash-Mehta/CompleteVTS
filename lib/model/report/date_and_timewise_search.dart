class DateAndTimeWiseSearchModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<DateAndTimeWiseSearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DateAndTimeWiseSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DateAndTimeWiseSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DateAndTimeWiseSearchData>[];
      json['data'].forEach((v) {
        var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new DateAndTimeWiseSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DateAndTimeWiseSearchData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DateAndTimeWiseSearchData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DateAndTimeWiseSearchData.fromJson(v));
      });
    }
  }
...
class DateAndTimeWiseSearchData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  DateAndTimeWiseSearchData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo']??"";
    imeino = json['imeino']??"";
