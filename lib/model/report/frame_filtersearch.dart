class FrameFilterSearchModel {
  ...
  String? nextPage;
  String? previousPage;
  List<FrameFilterSearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  FrameFilterSearchModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  FrameFilterSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <FrameFilterSearchData>[];
      json['data'].forEach((v) {
        // data!.add(new FrameFilterSearchData.fromJson(v));
         var searchdata = v['datewiseFramepacketData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new FrameFilterSearchData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<FrameFilterSearchData>? datewiseFramepacketData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseFramepacketData'] != null) {
      datewiseFramepacketData = <FrameFilterSearchData>[];
      json['datewiseFramepacketData'].forEach((v) {
        datewiseFramepacketData!.add(new FrameFilterSearchData.fromJson(v));
      });
    }
  }
...
class FrameFilterSearchData {
  ...
  FrameFilterSearchData.fromJson(Map<String, dynamic> json) {
