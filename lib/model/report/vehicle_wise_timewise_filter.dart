class VehicleWiseTimeWiseFilterModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<VehihcleWiseTimeWiseFilterData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  VehicleWiseTimeWiseFilterModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  VehicleWiseTimeWiseFilterModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <VehihcleWiseTimeWiseFilterData>[];
      json['data'].forEach((v) {
        var filterdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        filterdata.forEach((element) {
          data!.add(new VehihcleWiseTimeWiseFilterData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<VehihcleWiseTimeWiseFilterData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <VehihcleWiseTimeWiseFilterData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new VehihcleWiseTimeWiseFilterData.fromJson(v));
      });
    }
  }
...
class VehihcleWiseTimeWiseFilterData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  VehihcleWiseTimeWiseFilterData(
      {this.vehicleRegNo,
      this.imeino,
      this.latitude,
      this.longitude,
  ...
  VehihcleWiseTimeWiseFilterData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'] ?? "";
    imeino = json['imeino'] ?? "";
