...
DistanceSummarySearch getDriverMasterReportResponseFromJson(String str) =>
    DistanceSummarySearch.fromJson(json.decode(str));

String getDriverMasterReportResponseToJson(DistanceSummarySearch data) =>
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        ...
        datewisetraveldata.forEach((element) {
          dist!.add(DistanceSearch.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DistanceSearch>? distanceSummary;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['distanceSummary'] != null) {
      distanceSummary = <DistanceSearch>[];
      json['distanceSummary'].forEach((v) {
        distanceSummary!.add(new DistanceSearch.fromJson(v));
      });
    }
  }
...
class DistanceSearch {
  ...
  DistanceSearch.fromJson(Map<String, dynamic> json) {
