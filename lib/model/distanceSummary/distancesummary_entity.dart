class DistancesummaryEntity {
  ...
  DistancesummaryEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      dist = <DistanceSummary>[];
      json['data'].forEach((v) {
        var datewisetraveldata =
        v['distanceSummary'] as List<dynamic>;
        datewisetraveldata.forEach((element) {
          dist!.add(DistanceSummary.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DistanceSummary>? distanceSummary;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['distanceSummary'] != null) {
      ...
      json['distanceSummary'].forEach((v) {
        distanceSummary!.add(new DistanceSummary.fromJson(v));
      });
    }
  }
...
class DistanceSummary {
  ...
  DistanceSummary.fromJson(Map<String, dynamic> json) {
