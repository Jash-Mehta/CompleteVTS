class SearchDatewiseTravelHistryRpt {
  ...
  String? nextPage;
  String? previousPage;
  List<DatewiseTravelHistorySearchData>? data;
  bool? succeeded;
  String? errors;
  String? message;
  ...
  SearchDatewiseTravelHistryRpt.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  List<DatewiseTravelHistorySearchData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DatewiseTravelHistorySearchData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DatewiseTravelHistorySearchData.fromJson(v));
      });
    }
  }
...
class DatewiseTravelHistorySearchData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  DatewiseTravelHistorySearchData(
      {this.vehicleRegNo,
      this.imeino,
      this.latitude,
      this.longitude,
  ...
  DatewiseTravelHistorySearchData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
