class DateWiseTravelFilterModel {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<DatewiseTravelFilterData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DateWiseTravelFilterModel(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DateWiseTravelFilterModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DatewiseTravelFilterData>[];
      json['data'].forEach((v) {
        var travelfilterdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        travelfilterdata.forEach((element) {
          data!.add(new DatewiseTravelFilterData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DatewiseTravelFilterData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DatewiseTravelFilterData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DatewiseTravelFilterData.fromJson(v));
      });
    }
  }
...
class DatewiseTravelFilterData {
  String? vehicleRegNo;
  String? imeino;
  String? latitude;
  String? longitude;
  ...
  DatewiseTravelFilterData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
