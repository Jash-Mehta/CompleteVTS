class DateWiseTravelHFilterSearch {
  int? pageNumber;
  int? pageSize;
  String? firstPage;
  String? lastPage;
  ...
  String? nextPage;
  String? previousPage;
  List<DatewiseTravelHFSData>? data;
  bool? succeeded;
  String? errors;
  String? message;

  DateWiseTravelHFilterSearch(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DateWiseTravelHFilterSearch.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DatewiseTravelHFSData>[];
      json['data'].forEach((v) {
        // data!.add(new DatewiseTravelHFSData.fromJson(v));
         var searchdata = v['datewiseTravelHistoryData'] as List<dynamic>;
        searchdata.forEach((element) {
          data!.add(new DatewiseTravelHFSData.fromJson(element));
        });
      });
    }
...
class Data {
  ...
  List<DatewiseTravelHFSData>? datewiseTravelHistoryData;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datewiseTravelHistoryData'] != null) {
      datewiseTravelHistoryData = <DatewiseTravelHFSData>[];
      json['datewiseTravelHistoryData'].forEach((v) {
        datewiseTravelHistoryData!
            .add(new DatewiseTravelHFSData.fromJson(v));
      });
    }
  }
...
class DatewiseTravelHFSData {
  ...
  DatewiseTravelHFSData.fromJson(Map<String, dynamic> json) {
    vehicleRegNo = json['vehicleRegNo'];
    imeino = json['imeino'];
