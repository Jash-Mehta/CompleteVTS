class DriverWiseVehicleFilter {
  ...
  String? nextPage;
  Null? previousPage;
  List<DriverFilterData>? data;
  bool? succeeded;
  Null? errors;
  Null? message;

  DriverWiseVehicleFilter(
      {this.pageNumber,
      this.pageSize,
      this.firstPage,
      this.lastPage,
  ...
  DriverWiseVehicleFilter.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new DriverFilterData.fromJson(v));
      });
    }
...
class DriverFilterData {
  ...
  DriverFilterData.fromJson(Map<String, dynamic> json) {
    vsrNo = json['vsrNo'];
