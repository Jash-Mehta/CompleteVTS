...
//
//     final startLocationImei = startLocationImeiFromJson(jsonString);

import 'dart:convert';

List<StartLocationImei> startLocationImeiFromJson(String str) => List<StartLocationImei>.from(json.decode(str).map((x) => StartLocationImei.fromJson(x)));

String startLocationImeiToJson(List<StartLocationImei> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class StartLocationImei {
    int transactionId;
    String vehicleRegNo;
    String speed;
    String latitude;
    ...
    factory StartLocationImei.fromJson(Map<String, dynamic> json) => StartLocationImei(
