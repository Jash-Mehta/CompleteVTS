...
LiveTrackingFilterResponse liveTrackingFilterResponseFromJson(String str) =>
    LiveTrackingFilterResponse.fromJson(json.decode(str));

String liveTrackingFilterResponseToJson(LiveTrackingFilterResponse data) =>
...
class LiveTrackingFilterResponse {
  ...
  factory LiveTrackingFilterResponse.fromJson(Map<String, dynamic> json) =>
      LiveTrackingFilterResponse(
        data: json["data"] == null
            ? null
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        vehicleRegNo:
            json["vehicleRegNo"] == null ? null : json["vehicleRegNo"],
        ...
        distancetravel:
            json["distancetravel"] == null ? null : json["distancetravel"],
        noOfSatelite:
            json["noOfSatelite"] == null ? null : json["noOfSatelite"],
        address: json["address"] == null ? null : json["address"],
        alertIndication:
            json["alertIndication"] == null ? null : json["alertIndication"],
        vehicleType: json["vehicleType"] == null ? null : json["vehicleType"],
        date: json["date"] == null ? null : json["date"],
        time: json["time"] == null ? null : json["time"],
        previousTime:
            json["previousTime"] == null ? null : json["previousTime"],
        vehicleStatus:
            json["vehicleStatus"] == null ? null : json["vehicleStatus"],
        heading: json["heading"] == null ? null : json["heading"],
        imei: json["imei"] == null ? null : json["imei"],
        mainPowerStatus:
            json["mainPowerStatus"] == null ? null : json["mainPowerStatus"],
        gpsFix: json["gpsFix"] == null ? null : json["gpsFix"],
        internalBatteryVoltage: json["internalBatteryVoltage"] == null
            ? null
            : json["internalBatteryVoltage"],
