class TravelSummarySearch {
  ...
  TravelSummarySearch.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        ...
        datewisetraveldata.forEach((element) {
          datewise!.add(DatewiseStatusWiseTravelSearch.fromJson(element));
        });
      });
    }
...
class DatewiseStatusWiseTravelSearch {
  var srNo;
  String? tDate;
  String? imei;
  String? vehicleregNo;
  ...
  DatewiseStatusWiseTravelSearch(
      {this.srNo,
      this.tDate,
      this.imei,
      this.vehicleregNo,
  ...
  DatewiseStatusWiseTravelSearch.fromJson(Map<String, dynamic> json) {
    srNo = json['srNo'];
    tDate = json['tDate'];
    imei = json['imei'];
