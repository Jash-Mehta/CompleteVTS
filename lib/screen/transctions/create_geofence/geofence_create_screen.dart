...
class _GeofenceCreateScreenState extends State<GeofenceCreateScreen> {
  ...
  void initState() {
    ...
    geofenceScrollController.addListener(() {
      if(geofenceScrollController.position.maxScrollExtent==geofenceScrollController.offset){
  ...
  _getGeofenceCreatedetail(){
    _mainBloc.add(GetGeofenceCreateDetailEvents(vendorId: vendorid,branchId: branchid,pageNumber: pageNumber,pageSize: pageSize,token: token));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar().getCustomAppBar("GEOFENCE CREATE", _scaffoldKey,0,context),
        ...
        listener:(context,state){
          if (state is GetGeofenceCreateDetailLoadingState) {
            ...
            setState(() {
              _isLoading = false;
              pageNumber++;
              totalgeofenceCreateRecords=state.geofenceCreateDetailsResponse.totalRecords!;
                              ...
                              children: [
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                const EdgeInsets.only(top: 4.0),
                                                child: Text(
                                                  data![index].geofenceName.toString(),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  // "Yes",
                                                  data![index].showGeofence.toString(),
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(
                                                      color: MyColors.text5ColorCode,
                                                      fontSize: 18),
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    _deleteRecordConfirmation(data![index].srNo!);
                                  },
                                  child: Container(
                                    height: 37,
                              ...
                              children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                // "23",
                                                searchData![index].srNo.toString(),
                                                style: TextStyle(
                                                    color: MyColors.text5ColorCode,
                                                    fontSize: 18),
                                              ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                const EdgeInsets.only(top: 4.0),
                                                child: Text(
                                                  searchData![index].geofenceName.toString(),
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(
                                                      color: MyColors.text5ColorCode,
                                                      fontSize: 18),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            const EdgeInsets.only(top: 4.0),
                                            child: Text(
                                              searchData![index].category.toString(),
                                              style: TextStyle(
                                                  color: MyColors.text5ColorCode,
                                                  fontSize: 18),
                                            ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(top: 4.0),
                                              child: Text(
                                                searchData![index].tolerance.toString(),
                                                textAlign: TextAlign.left,
                                                style: TextStyle(
                                                    color: MyColors.text5ColorCode,
                                                    fontSize: 18),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              const EdgeInsets.only(top: 4.0),
                                              child: Text(
                                                searchData![index].vehicleRegno.toString(),
                                                style: TextStyle(
                                                    color: MyColors.text5ColorCode,
                                                    fontSize: 18),
                                              ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  // "Yes",
                                                  searchData![index].showGeofence.toString(),
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(
                                                      color: MyColors.text5ColorCode,
                                                      fontSize: 18),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 4.0),
                                      child: Text(
                                        searchData![index].description.toString(),
                                        textAlign: TextAlign.left,
                                        style: TextStyle(
                                            color: MyColors.text5ColorCode,
                                            fontSize: 18),
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    // _deleteRecordConfirmation(searchData![index].srNo!);
                                  },
                                  child: Container(
                                    height: 37,
                                    margin: EdgeInsets.only(top: 15),
                        ...
                        Padding(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () {
                              ...
                              _mainBloc.add(DeleteGeofenceCreateEvents(vendorId: vendorid,branchId: branchid,geofenceId:geofenceId ,token: token));
