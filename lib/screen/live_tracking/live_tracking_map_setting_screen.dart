      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Geofence",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
            Row(
              children: [
                Checkbox(
                    value: all,
            ...
            Row(
              children: [
                Expanded(
                    child: Text("Show Cluster",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)
                ),
                Switch(
                  value: isCluster,
                  onChanged: (value) {
            ...
            Row(
              children: [
                Expanded(
                    child: Text("Show Label",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)
                ),
                Switch(
                  value: isLabel,
                  onChanged: (value) {
