...
class LiveTrackingDetailsScreen extends StatefulWidget {
  int transactionId;
  String araiNonarai;
  LiveTrackingDetailsScreen({Key? key,required this.transactionId,required this.araiNonarai}) : super(key: key);

  @override
  _LiveTrackingDetailsScreenState createState() => _LiveTrackingDetailsScreenState();
}
...
class _LiveTrackingDetailsScreenState extends State<LiveTrackingDetailsScreen> {
  ...
  List<String> speedList=['X1','X2','X3','X4','X5','X6','X7','X8','X9','X10'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(liveTrackingByIdRespons.length==0 ? "" : liveTrackingByIdRespons[0].driverName!),
        actions: [
         /* IconButton(
              onPressed: () {
                setState(() {
      ...
      floatingActionButton:isPlayClick ? null :liveTrackingByIdRespons.length==0 ? null :  FloatingActionButton(
          mini: true,
      ...
      bottomSheet:isPlayClick ? BottomAppBar(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Image.asset("assets/paly_icon.png",height: 40,width: 40,),
              Image.asset("assets/pause_icon.png",height: 40,width: 40,),
              Image.asset("assets/stop_icon.png",height: 40,width: 40,),
        ...
        draggableBody: true,
        headerBar: liveTrackingByIdRespons.length==0 ? Container() : Container(
          decoration: const BoxDecoration(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color:
                            liveTrackingByIdRespons[0].vehicleStatus=="Stop" ? MyColors.analyticStoppedColorCode :liveTrackingByIdRespons[0].vehicleStatus=="Nodata" ? MyColors.analyticnodataColorCode : liveTrackingByIdRespons[0].vehicleStatus=="Overspeed" ? MyColors.analyticoverSpeedlColorCode:liveTrackingByIdRespons[0].vehicleStatus=="Running" ? MyColors.analyticGreenColorCode :liveTrackingByIdRespons[0].vehicleStatus=="Idle" ? MyColors.analyticIdelColorCode :liveTrackingByIdRespons[0].vehicleStatus=="Inactive" ? MyColors.analyticActiveColorCode :liveTrackingByIdRespons[0].vehicleStatus=="Total" ? MyColors.yellowColorCode :
                      ...
                      Container(
                          ...
                          child:  Center(
                            child: Padding(
                              ...
                              child: Center(
                                  child: Text(
                                    liveTrackingByIdRespons[0].date!.toString()+"|"+liveTrackingByIdRespons[0].time.toString(),
                                    style: TextStyle(
                      ...
                      Container(
                          ...
                          child:  Center(
                            child: Padding(
                              ...
                              child: Center(
                                  child: Text(
                                    "Speed : "+liveTrackingByIdRespons[0].speed!.toString()+"- kph",
                                    style: TextStyle(
                                        color: MyColors.blueColorCode,
                                        fontSize: 12),
                                  )),
        ...
        body: liveTrackingByIdRespons.length==0 ? Container() : ListView(
          children: [
            Padding(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            Share.share(liveTrackingByIdRespons[0].address!+"\n"+liveTrackingByIdRespons[0].vehicleRegNo!);
                          },
                          child: Container(
                            height: 36,
                            width: 36,
                        ...
                        children: [
                          Container(
                            ...
                            child:  Icon(
                              ...
                              size: 18,
                              color:
                              liveTrackingByIdRespons[0].ignition=="OFF"
                          ...
                          Text("IGN",
                              style: TextStyle(
                                  fontSize: 10,
                                  color:
                                  liveTrackingByIdRespons[0].ignition=="OFF" ? MyColors.text4ColorCode :
                                  MyColors.analyticGreenColorCode
                              )
                          )
                        ],
                        ...
                        children: [
                          Container(
                            ...
                            child:  Icon(
                              ...
                              size: 18,
                              color:
                              liveTrackingByIdRespons[0].mainPowerStatus=="0"
                                  ? MyColors.text4ColorCode :
                              MyColors.analyticGreenColorCode,
                            ),
                          ),
                          ...
                          Text("PWR",
                            style: TextStyle(
                                fontSize: 10,
                                color:
                                liveTrackingByIdRespons[0].mainPowerStatus=="0" ? MyColors.text4ColorCode :
                                MyColors.analyticGreenColorCode
                        ...
                        children: [
                          Container(
                            ...
                            child:  Icon(
                              ...
                              size: 18,
                              color:
                              liveTrackingByIdRespons[0].ac=="OFF"
                                  ? MyColors.text4ColorCode :
                              MyColors.analyticGreenColorCode,
                            ),
                          ),
                          ...
                          Text("AC",
                              style: TextStyle(
                                  fontSize: 10,
                                  color:
                                  liveTrackingByIdRespons[0].ac=="OFF" ? MyColors.text4ColorCode :
                                  MyColors.analyticGreenColorCode
                        ...
                        children: [
                          Container(
                            ...
                            child:  Icon(
                              ...
                              size: 18,
                              color:
                              liveTrackingByIdRespons[0].door=="OFF"
                                  ? MyColors.text4ColorCode :
                              MyColors.analyticGreenColorCode,
                            ),
                          ),
                          ...
                          Text("DOOR",
                              style: TextStyle(
                                  fontSize: 10,
                                  color:
                                  liveTrackingByIdRespons[0].door=="OFF" ? MyColors.text4ColorCode :
                                  MyColors.analyticGreenColorCode
                        ...
                        children: [
                          Container(
                            ...
                            child:  Icon(
                              ...
                              size: 18,
                              color:
                              liveTrackingByIdRespons[0].gpsFix=="OFF"
                                  ? MyColors.text4ColorCode :
                              MyColors.analyticGreenColorCode,
                            ),
                          ),
                          ...
                          Text("GPS",
                              style: TextStyle(
                                  fontSize: 10,
                                  color:
                                  liveTrackingByIdRespons[0].gpsFix=="OFF" ? MyColors.text4ColorCode :
                                  MyColors.analyticGreenColorCode
                              ))
                        ],
                      ),
                  ...
                  ListTile(
                    ...
                    title: Row(
                      ...
                      children: [
                        ...
                        Text(
                            liveTrackingByIdRespons[0].odometer!.toString()
                          // "99999"
                        )
                      ],
                    ),
                        ...
                        Row(
                          children: [
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].parking!.atLastStop!.toString(),
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                            ...
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].parking!.total!.toString(),
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                        ...
                        Row(
                          children: [
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].runningDuration!.atLastStop!,
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                            ...
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].runningDuration!.total!.toString(),
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                        ...
                        Row(
                          children: [
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].runningDistance!.fromLastStop!,
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                            ...
                            Column(
                              ...
                              children:  [
                                Text(
                                  liveTrackingByIdRespons[0].runningDistance!.total!,
                                  // "00:00",
                                  style: TextStyle(fontSize: 14),
                                ),
                                SizedBox(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            ...
                            children:  [
                              Text(
                                liveTrackingByIdRespons[0].alerts!.length.toString(),
                                // "4",
                                style: TextStyle(
                                    fontSize: 14,
  ...
  getlivetackingByIdDetail(){
    _mainBloc.add(LiveTrackingByIdEvents(vendorId: vendorid,branchId: branchid,token: token, araiNonarai: widget.araiNonarai/*'nonarai'*/, transactionId: widget.transactionId));
  }
        ...
        listener: (context,state){
          if (state is LiveTrackingByIdLoadingState) {
            ...
            setState(() {
              ...
              showLocation=LatLng(double.parse(state.liveTrackingByIdResponse[0].latitude!),double.parse(state.liveTrackingByIdResponse[0].longitude!));
            });
    ...
    setState(() {
      if(liveTrackingByIdRespons.length!=0){
        _marker.add(Marker( //add second marker
          ...
          position: LatLng(double.parse(liveTrackingByIdRespons[0].latitude!),double.parse(liveTrackingByIdRespons[0].longitude!)/*27.7099116, 85.3132343*//*18.6298, 73.7997*/), //position of marker
