...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar().getCustomAppBar("Settings",_scaffoldKey,0,context),   
      body: _profile(),   
    );   
  }
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              ...
              child:_profileDetail("Start Up Screen",1) ,
            ),
            _profileDetail("Alerts",2),
            _profileDetail("Map Setting",3),
            _profileDetail("Support/Help",4),
          ],
        ),
      ),
    );
